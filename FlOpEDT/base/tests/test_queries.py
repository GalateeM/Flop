...
class FirstDepartmentTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.week1 = models.Week.objects.create(nb=1, year=2018)
        cls.week2 = models.Week.objects.create(nb=2, year=2018)
        cls.edt_version_1 = models.EdtVersion.objects.create(week=cls.week1, version=0)
        cls.edt_version_2 = models.EdtVersion.objects.create(week=cls.week2, version=0)
        cls.regen1 = models.Regen(week=cls.week1)
        cls.regen2 = models.Regen(week=cls.week2)
...
class EdtVersionTestCase(TestCase):
    def setUp(self):
        ...
        self.week40 = models.Week.objects.create(nb=40, year=2018)
        self.edt2 = models.EdtVersion.objects.create(department=self.d1, week=self.week40, version=2)
    ...
    def test_get_version_multiple_objects_exist(self):
        self.edt3 = models.EdtVersion.objects.create(department=self.d1, week=self.week40, version=2)
...
class ScheduledCourseTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.week39 = models.Week.objects.create(nb=39, year=2018)
        cls.c1 = models.Course.objects.create(week=cls.week39, type=cls.ct1, module=cls.m1)
